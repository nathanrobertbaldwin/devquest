...
export default function CreateNewEquipmentModal() {
  ...
  async function handleSubmit(e) {
    ...
    if (_.isEmpty(validationErrors)) {
      ...
      const newEquipmentId = await dispatch(
        createNewEquipmentThunk(newEquipmentData)
      );
      console.log("FROM FUNCTION", newEquipmentId);
      _reset();
      closeModal();
      history.push(`/equipment/${newEquipmentId}`);
    }
  }
